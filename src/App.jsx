      ...
      <div class="max-w-5xl mx-auto">
        ...
        <section class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-10">
          {data.map((item) => (
            <div
              key={item.id}
              class="flex flex-col items-start justify-start gap-4 rounded-xl px-4 py-4 bg-gray-800 border-1 border-gray-400 dark:bg-gray-100 dark:text-white"
            >
              ...
              <div class="flex gap-4 items-center justify-between mt-8 w-full">
                <a
                  href="#"
                  class="py-1 px-4 rounded-3xl bg-gray-700 border-1 border-gray-400 text-white"
                >
                  Remove
                </a>
                ...
                <label for="name" class="text-white text-end">
                  ...
                  <div class="relative w-9 h-5 bg-red-400 peer rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600 dark:peer-checked:bg-blue-600"></div>
                </label>
              </div>
            </div>
          ))}
